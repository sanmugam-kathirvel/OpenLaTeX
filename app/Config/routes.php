 ...
 */
	...
	Router::connect('/adash', array('controller' => 'pages', 'action' => 'anoysdashboard'));
	Router::connect('/compile', array('controller' => 'pages', 'action' => 'compile'));
	Router::connect('/delete', array('controller' => 'pages', 'action' => 'delete'));
	Router::connect('/templates', array('controller' => 'templates', 'action' => 'templates'));
	Router::connect('/usetemplate', array('controller' => 'templates', 'action' => 'usetemplate'));
	//Router::connect('/readlog', array('controller' => 'pages', 'action' => 'anoysdashboard'));
